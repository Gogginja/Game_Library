...
public class PongFrame extends JFrame implements Runnable{
    ...
    final int SCREEN_HEIGHT = (int)(SCREEN_WIDTH * (0.5555));
    final int PLAYER_WIDTH = 10;
    final int PLAYER_HEIGHT = 40;
    final int BALL_X = 6;
    final int BALL_Y = 5;
    public PongRectangle playerOne, playerTwo, ball, invisibleBall;
    String string = "";
    boolean lost = false;
    ...
    public PongFrame() {
        ...
        playerOne = new PongRectangle(PLAYER_WIDTH, PLAYER_HEIGHT, 10, 10);
        playerTwo = new PongRectangle(PLAYER_WIDTH, PLAYER_HEIGHT, SCREEN_WIDTH - PLAYER_WIDTH - 10 ,
                SCREEN_HEIGHT - PLAYER_HEIGHT - 10);
        ball = new PongRectangle(10, 10, SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2);
        ball.dx = BALL_X;
        ball.dy = BALL_Y;
        invisibleBall = new PongRectangle(5, 5, SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2);
